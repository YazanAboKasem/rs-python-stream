...
CAMERAS = [
    {
        ...
        # For USB/webcam:
        "source_linux": "v4l2src device=/dev/video0",
        "source_macos": "avfvideosrc device-index=0",
    ...
    },
    {
        ...
        # For USB/webcam (second camera):
        "source_linux": "v4l2src device=/dev/video2",
        "source_macos": "avfvideosrc device-index=1",
        # For IP camera (uncomment to use instead of USB):
